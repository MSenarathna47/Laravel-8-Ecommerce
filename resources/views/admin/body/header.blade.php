            ...
            <div class="navbar-brand-box">
                ...
                <a href="index.html" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        ...
                        <<img src="{{asset('frontend/assets/images/logo.png')}}" alt="logo-light" height="30">
                        {{-- <h4 class="m-3" style="color:aliceblue;">FilpsMart Admin</h4> --}}
                    </span>
                </a>
            </div>
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user" src="{{ (!empty($adminData->profile_photo_path)) ?
                        url('upload/admin_images/'.$adminData->profile_photo_path):url('upload/No_Image_Available.jpg')}}"
                        alt="Header Avatar">
