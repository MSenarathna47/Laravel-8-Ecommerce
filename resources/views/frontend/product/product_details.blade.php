                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select id="color" class="form-control unicase-form-control selectpicker" style="display: none;" id="color">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select id="size" class="form-control unicase-form-control selectpicker" style="display: none;" id="size">
